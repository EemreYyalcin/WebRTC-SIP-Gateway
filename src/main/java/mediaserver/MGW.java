...
public class MGW implements JainMgcpExtendedListener {
	...
	public void checkState() {
		// CreateConnectionTest.assertTrue("Expect to sent CRCX Response",
		// responseSent);
	}
	...
	public void processMgcpCommandEvent(JainMgcpCommandEvent jainmgcpcommandevent) {
		...
		case Constants.CMD_CREATE_CONNECTION:
			...
			if (this.sendFailedResponse) {
				response = new CreateConnectionResponse(jainmgcpcommandevent.getSource(), ReturnCode.Endpoint_Unknown, new ConnectionIdentifier("0"));
				...
				response = new CreateConnectionResponse(jainmgcpcommandevent.getSource(), ReturnCode.Transaction_Executed_Normally, connectionIdentifier);
